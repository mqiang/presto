...
public class DruidClient
{
    ...
    private Request prepareMetadataQuery(String query)
    {
        ...
        return setContentTypeHeaders(preparePost())
                ...
                .setBodyGenerator(createStaticBodyGenerator(createRequestBody(query, DruidResultFormat.OBJECT, false)))
                .build();
    }
    ...
    private Request prepareDataQuery(String query)
    {
        ...
        return setContentTypeHeaders(preparePost())
                .setUri(uriBuilder.build())
                .setBodyGenerator(createStaticBodyGenerator(createRequestBody(query, DruidResultFormat.ARRAY_LINES, false)))
                .build();
    }
